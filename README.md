...
```
curl "https://nubesgen.com/demo.zip?iactool=TERRAFORM&region=eastus&application=FUNCTION.consumption&runtime=DOCKER&database=SQL_SERVER.general_purpose" | tar -xzvf -
```
